package com.spring.crud.app.example.api.handler;

import com.spring.crud.app.example.api.error.ErrorDetail;
import com.spring.crud.app.example.api.error.ResourceNotFoundDetails;
import com.spring.crud.app.example.api.error.ValidationErrorDetails;
